...
- [PRIMARY PATTERN: useSuspenseQuery](#primary-pattern-usesuspensequery)
  - [Why useSuspenseQuery?](#why-usesuspensequery)
  - [Basic Pattern](#basic-pattern)
  - [useSuspenseQuery vs useQuery](#usesuspensequery-vs-usequery)
- [Cache-First Strategy](#cache-first-strategy)
  - [Cache-First Pattern Example](#cache-first-pattern-example)
- [Parallel Data Fetching](#parallel-data-fetching)
  - [useSuspenseQueries](#usesuspensequeries)
- [Query Keys Organization](#query-keys-organization)
  - [Naming Convention](#naming-convention)
  - [Query Key Examples](#query-key-examples)
- [API Service Layer Pattern](#api-service-layer-pattern)
  - [File Structure](#file-structure)
  - [Service Pattern (from postApi.ts)](#service-pattern-from-postapits)
- [Route Format Rules (IMPORTANT)](#route-format-rules-important)
  - [Correct Format](#correct-format)
- [Mutations](#mutations)
  - [Basic Mutation Pattern](#basic-mutation-pattern)
  - [Optimistic Updates](#optimistic-updates)
- [Advanced Query Patterns](#advanced-query-patterns)
  - [Prefetching](#prefetching)
  - [Cache Access Without Fetching](#cache-access-without-fetching)
  - [Dependent Queries](#dependent-queries)
- [API Client Configuration](#api-client-configuration)
  - [Using apiClient](#using-apiclient)
- [Error Handling in Queries](#error-handling-in-queries)
  - [onError Callback](#onerror-callback)
  - [Error Boundaries](#error-boundaries)
- [Complete Examples](#complete-examples)
  - [Example 1: Simple Entity Fetch](#example-1-simple-entity-fetch)
  - [Example 2: Cache-First Strategy](#example-2-cache-first-strategy)
  - [Example 3: Parallel Fetching](#example-3-parallel-fetching)
- [Mutations with Cache Invalidation](#mutations-with-cache-invalidation)
  - [Update Mutation](#update-mutation)
  - [Delete Mutation](#delete-mutation)
- [Query Configuration Best Practices](#query-configuration-best-practices)
