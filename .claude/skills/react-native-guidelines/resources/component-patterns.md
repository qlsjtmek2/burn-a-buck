...
- [React.FC Pattern (PREFERRED)](#reactfc-pattern-preferred)
  - [Why React.FC](#why-reactfc)
  - [Basic Pattern](#basic-pattern)
- [Lazy Loading Pattern](#lazy-loading-pattern)
  - [When to Lazy Load](#when-to-lazy-load)
  - [How to Lazy Load](#how-to-lazy-load)
...
- [Component Separation](#component-separation)
  ...
  - [When to Keep Together](#when-to-keep-together)
- [Export Patterns](#export-patterns)
  - [Named Const + Default Export (PREFERRED)](#named-const--default-export-preferred)
  - [Lazy Loading Named Exports](#lazy-loading-named-exports)
- [Component Communication](#component-communication)
  - [Props Down, Events Up](#props-down-events-up)
  - [Avoid Prop Drilling](#avoid-prop-drilling)
- [Advanced Patterns](#advanced-patterns)
  - [Compound Components](#compound-components)
  - [Render Props (Rare, but useful)](#render-props-rare-but-useful)
- [Summary](#summary)
