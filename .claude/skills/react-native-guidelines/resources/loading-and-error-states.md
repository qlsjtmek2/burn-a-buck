...
- [⚠️ CRITICAL RULE: Never Use Early Returns](#️-critical-rule-never-use-early-returns)
  - [The Problem](#the-problem)
  - [The Solutions](#the-solutions)
- [SuspenseLoader Component](#suspenseloader-component)
  - [What It Does](#what-it-does)
  - [Import](#import)
  - [Basic Usage](#basic-usage)
  - [With useSuspenseQuery](#with-usesuspensequery)
  - [Multiple Suspense Boundaries](#multiple-suspense-boundaries)
  - [Nested Suspense](#nested-suspense)
- [LoadingOverlay Component](#loadingoverlay-component)
  - [When to Use](#when-to-use)
  - [Usage](#usage)
- [Error Handling](#error-handling)
  - [useMuiSnackbar Hook (REQUIRED)](#usemuisnackbar-hook-required)
  - [TanStack Query Error Callbacks](#tanstack-query-error-callbacks)
  - [Error Boundaries](#error-boundaries)
- [Complete Examples](#complete-examples)
  - [Example 1: Modern Component with Suspense](#example-1-modern-component-with-suspense)
  - [Example 2: Legacy Pattern with LoadingOverlay](#example-2-legacy-pattern-with-loadingoverlay)
  - [Example 3: Error Handling with Snackbar](#example-3-error-handling-with-snackbar)
- [Loading State Anti-Patterns](#loading-state-anti-patterns)
  - [❌ What NOT to Do](#-what-not-to-do)
  - [✅ What TO Do](#-what-to-do)
- [Skeleton Loading (Alternative)](#skeleton-loading-alternative)
  - [MUI Skeleton Component](#mui-skeleton-component)
- [Summary](#summary)
