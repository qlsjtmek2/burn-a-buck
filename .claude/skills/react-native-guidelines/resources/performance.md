...
- [Debounced Search](#debounced-search)
  - [Using use-debounce Hook](#using-use-debounce-hook)
- [Memory Leak Prevention](#memory-leak-prevention)
  - [Cleanup Timeouts/Intervals](#cleanup-timeoutsintervals)
  - [Cleanup Event Listeners](#cleanup-event-listeners)
  - [Abort Controllers for Fetch](#abort-controllers-for-fetch)
- [Form Performance](#form-performance)
  - [Watch Specific Fields (Not All)](#watch-specific-fields-not-all)
- [List Rendering Optimization](#list-rendering-optimization)
  - [Key Prop Usage](#key-prop-usage)
  - [Memoized List Items](#memoized-list-items)
- [Preventing Component Re-initialization](#preventing-component-re-initialization)
