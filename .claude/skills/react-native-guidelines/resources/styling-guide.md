...
- [Inline vs Separate Styles](#inline-vs-separate-styles)
  - [Decision Threshold](#decision-threshold)
  - [Real Example: UnifiedForm.tsx](#real-example-unifiedformtsx)
- [sx Prop Patterns](#sx-prop-patterns)
  - [Basic Usage](#basic-usage)
  - [With Theme Access](#with-theme-access)
  - [Responsive Styles](#responsive-styles)
  - [Pseudo-Selectors](#pseudo-selectors)
- [MUI v7 Patterns](#mui-v7-patterns)
  - [Grid Component (v7 Syntax)](#grid-component-v7-syntax)
  - [Responsive Grid](#responsive-grid)
  - [Nested Grids](#nested-grids)
- [Type-Safe Styles](#type-safe-styles)
  - [Style Object Type](#style-object-type)
  - [Theme-Aware Styles](#theme-aware-styles)
- [What NOT to Use](#what-not-to-use)
  - [❌ makeStyles (MUI v4 pattern)](#-makestyles-mui-v4-pattern)
  - [❌ styled() Components](#-styled-components)
  - [✅ Use sx Prop Instead](#-use-sx-prop-instead)
