...
- [Explicit Return Types](#explicit-return-types)
  ...
  - [Component Return Types](#component-return-types)
- [Type Imports](#type-imports)
  - [Use 'type' Keyword](#use-type-keyword)
- [Component Prop Interfaces](#component-prop-interfaces)
  - [Interface Pattern](#interface-pattern)
  - [Props with Children](#props-with-children)
...
- [Type Assertions (Use Sparingly)](#type-assertions-use-sparingly)
