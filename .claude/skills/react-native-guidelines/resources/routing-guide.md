...
- [TanStack Router Overview](#tanstack-router-overview)
- [Folder-Based Routing](#folder-based-routing)
  - [Directory Structure](#directory-structure)
- [Basic Route Pattern](#basic-route-pattern)
  - [Example from posts/index.tsx](#example-from-postsindextsx)
- [Lazy Loading Routes](#lazy-loading-routes)
  - [Named Export Pattern](#named-export-pattern)
  - [Default Export Pattern](#default-export-pattern)
  - [Why Lazy Load Routes?](#why-lazy-load-routes)
- [createFileRoute](#createfileroute)
  - [Basic Configuration](#basic-configuration)
  - [With Breadcrumb Loader](#with-breadcrumb-loader)
  - [With Data Loader](#with-data-loader)
  - [With Search Params](#with-search-params)
...
- [Navigation](#navigation)
  ...
  - [With Search Params](#with-search-params-1)
- [Route Layout Pattern](#route-layout-pattern)
  - [Root Layout (__root.tsx)](#root-layout-__roottsx)
