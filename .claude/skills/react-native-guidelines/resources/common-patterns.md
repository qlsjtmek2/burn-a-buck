...
- [Authentication with useAuth](#authentication-with-useauth)
  - [Getting Current User](#getting-current-user)
- [Forms with React Hook Form](#forms-with-react-hook-form)
  - [Basic Form](#basic-form)
- [Dialog Component Pattern](#dialog-component-pattern)
  - [Standard Dialog Structure](#standard-dialog-structure)
- [DataGrid Wrapper Pattern](#datagrid-wrapper-pattern)
  - [Wrapper Component Contract](#wrapper-component-contract)
- [Mutation Patterns](#mutation-patterns)
  - [Update with Cache Invalidation](#update-with-cache-invalidation)
- [State Management Patterns](#state-management-patterns)
  - [TanStack Query for Server State (PRIMARY)](#tanstack-query-for-server-state-primary)
  - [useState for UI State](#usestate-for-ui-state)
  - [Zustand for Global Client State (Minimal)](#zustand-for-global-client-state-minimal)
- [Summary](#summary)
